...
% We are not able to say that \squintB out performs the previous two algorithms. In the setting of an equal number of iterations \NHB proved to be the best with both the lowest error rate and the least inconclusive tests (where applicable). 
