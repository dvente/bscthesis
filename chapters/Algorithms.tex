...
\todo{Ik heb hier en daar een operatie op $\forall i$ veranderd in een vector notatie(vb in stap 6 van \hedge, dat vond ik zelf wat fijner lezen. Ook heb ik op een plekken vb $h_t$ naar $h^t$ veranderd om consistent te blijven}
\begin{algorithm}
\caption{\hedge}
\begin{algorithmic}[1]
\Require 
